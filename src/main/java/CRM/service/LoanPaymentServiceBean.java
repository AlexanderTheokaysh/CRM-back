...
import CRM.repository.LoanPaymentRepository;
import CRM.repository.LoanSortingRepository;
import CRM.repository.PaymentSortingRepository;
...
//        entity.setDate(createDate);
    ...
    public LoanPromisesSearchQuery getPromiseLoans(Integer start, Integer limit, String id, String creditor, String debtor, String debtorIdentificator, String assignedAgent, Long amountStart, Long amountEnd, String dateStart, String dateEnd, Boolean withCheck) {
        ...
        List<BigDecimal> totalAmount = loanSortingRepository.loanTotalAmountSum(localId, employeeId, creditor, debtor, debtorIdentificator, formattedDateStart, formattedDateEnd, assignedAgent);
        List<BigDecimal> totalPromise = loanSortingRepository.loanPromisesSum(localId, employeeId, creditor, debtor, debtorIdentificator, formattedDateStart, formattedDateEnd, assignedAgent);
    ...
    public LoansWithoutCallDateQueryDTO getLoansWithoutCallDate(Integer start, Integer limit, String id, String creditor, String debtor, String debtorIdentificator, String assignedAgent, Long amountStart, Long amountEnd, String dateStart, String dateEnd, Boolean withCheck) {
        Long localId = null, employeeId = null;
        BigDecimal convertedAmountStart = null;
        BigDecimal convertedAmountEnd = null;
        ...
        LoansWithoutCallDateQueryDTO loansWithoutCallDateQueryDTO = new LoansWithoutCallDateQueryDTO();
        ...
        loansWithoutCallDateQueryDTO.setTotalAmount(totalAmount.get(0));


        return loansWithoutCallDateQueryDTO;
